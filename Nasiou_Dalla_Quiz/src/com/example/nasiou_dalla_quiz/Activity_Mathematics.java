...
public class Activity_Mathematics extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
	    ...
	    Toast.makeText(Activity_Mathematics.this, "Επιλέξατε τα Μαθηματικά.. Την κατηγορία "+category+"!!. Nα είστε προσεκτικοί με τις απαντήσεις σας!!", Toast.LENGTH_LONG).show();
